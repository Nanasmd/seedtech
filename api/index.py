...
if modules_loaded:
    try:
        ...
        load_caches()
        print("Caches chargés avec succès")
    except Exception as e:
        print(f"Erreur lors du chargement des caches: {e}")
...
def test_route():
    ...
    try:
        if not modules_loaded:
            return jsonify({'erreur': 'Modules non chargés'}), 500
...
if __name__ == "__main__":
    ...
    print("Configuration terminée, prêt à démarrer le serveur...")
    ...
    if env == "production":
        ...
        try:
            ...
            print("Waitress n'est pas installé. Utilisation du serveur de développement Flask à la place.")
            print("Démarrage du serveur en mode développement sur le port 8080")
